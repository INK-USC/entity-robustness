...
output_folder_path = f'{args.base_folder}/{args.dataset}/org/{args.out_candidates_folder_name}'
...
with open(args.nnp_path, 'r', encoding='utf-8') as f:
    nnp_lst = [line.strip() for line in f]
