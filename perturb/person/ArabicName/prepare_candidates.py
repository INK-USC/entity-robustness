...
parser.add_argument('--out_candidates_folder_name', default='ArabicName')

args = parser.parse_args()

input_dictionary_genderized_first_name_json = f'genderized_arabic_first_names.json'
input_last_name_txt = 'raw_data/surnames/arabic_surnames.txt'

output_folder_path = f'{args.base_folder}/{args.dataset}/person/{args.out_candidates_folder_name}'
os.makedirs(output_folder_path, exist_ok=True)

last_name_lst = []
with open(input_last_name_txt, 'r', encoding='utf-8') as f:
    for line in f:
