...
parser.add_argument('--out_candidates_folder_name', default='ChineseName')
parser.add_argument('--polarity_threshold', type=int, default=2)

args = parser.parse_args()

input_dictionary_genderized_first_name_json = f'genderized_zh_fisrt_name_polarity{args.polarity_threshold}.json'
input_last_name_csv = 'zh_last_name.csv'
...
with open(input_last_name_csv, 'r', encoding='utf-8') as f:
    for line in f:
        last_name, freq = line.strip().split(',')
