...
parser.add_argument('--out_candidates_folder_name', default='FrenchName')

args = parser.parse_args()

input_dictionary_genderized_first_name_json = f'genderized_french_first_names.json'
input_last_name_txt = 'raw_data/surnames/french_surnames.txt'
