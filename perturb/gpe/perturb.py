...
from faker import replace_in_doc_randstr, replace_in_doc_phrase, generate_randstr
...
if args.perturbation == 'none':
    ...
    out_path = f'{args.base_folder}/{args.dataset}/gpe/dev_subset.jsonl'
    ...
    os.makedirs(f'{args.base_folder}/{args.dataset}/gpe/RandStr', exist_ok=True)
    out_path = f'{args.base_folder}/{args.dataset}/gpe/RandStr/dev_subset_s{args.seed}.jsonl'
elif args.perturbation == 'candidates':
    assert args.candidates_folder_name != 'none'
    candidates_path = f'{args.base_folder}/{args.dataset}/gpe/{args.candidates_folder_name}/candidate_names.json'
    ...
    for data in subset_data_list:
        ...
        data["answers"]["text"] = answers
        output_data_list.append(data)
    out_path = f'{args.base_folder}/{args.dataset}/gpe/{args.candidates_folder_name}/dev_subset_s{args.seed}.jsonl'
else:
